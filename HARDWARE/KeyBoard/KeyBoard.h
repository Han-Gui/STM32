...
#define COL0_GPIO	GPIOG
#define COL1_GPIO	GPIOG
#define COL2_GPIO	GPIOG
#define COL3_GPIO	GPIOD

#define	ROW0_GPIO_BIT	GPIO_PIN_9
#define	ROW1_GPIO_BIT	GPIO_PIN_7
#define	ROW2_GPIO_BIT	GPIO_PIN_5
#define	ROW3_GPIO_BIT	GPIO_PIN_3

#define COL0_GPIO_BIT	GPIO_PIN_14
#define COL1_GPIO_BIT	GPIO_PIN_12
#define COL2_GPIO_BIT	GPIO_PIN_10
